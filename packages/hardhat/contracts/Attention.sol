...
/**
 * @title Attention Token Contract
 * @dev ERC20 token representing attention/engagement metrics in the Take2Save system
 * @custom:security-contact security@take2save.com
 */
contract Attention is ERC20, Ownable {
    /// @notice Address of the certification contract allowed to transfer tokens
    address public certificationContract;

    /**
     * @dev Constructor initializes the token with name "Attention" and symbol "ATTE"
     */
    constructor() 
        ERC20("Attention", "ATTE")
        Ownable(msg.sender)
    {}
