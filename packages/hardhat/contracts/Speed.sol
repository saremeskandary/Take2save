...
/**
 * @title Speed Token Contract
 * @dev ERC20 token representing speed/efficiency metrics in the Take2Save system
 * Speed tokens are earned by retailers based on service speed ratings
...
contract Speed is ERC20, Ownable {
    ...
    /**
     * @dev Constructor initializes the token with name "Speed" and symbol "SPD"
     */
    constructor()
        ERC20("Speed", "SPD")
        Ownable(msg.sender)
