  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Order #475601</p>
      </div>
      ...
      <div className="bg-white rounded-lg p-4 shadow-sm mb-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">PÃO DE AÇÚCAR - MARQUES DE ABRANTES</p>
      ...
      {showSupportModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            ...
            <p className="text-gray-600 mb-4">Our support team will help you with any issues regarding your order.</p>
            <div className="space-y-4">
              <a
                href="tel:+1234567890"
                className="w-full flex items-center justify-center gap-2 bg-green-500 text-white py-3 rounded-full"
