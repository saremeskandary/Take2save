    ...
    <div className="max-w-4xl mx-auto p-4">
      ...
      {products.length === 0 ? (
        <div className="text-center py-12 space-y-4">
          <div className="text-base-content/70">You haven't added any products yet</div>
          <div className="text-sm text-base-content/50">Start by adding your first product to your store</div>
        </div>
      ) : (
